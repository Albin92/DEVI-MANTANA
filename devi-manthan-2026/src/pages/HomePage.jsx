      ...
      <section style={{ marginTop: '40px', position: 'relative', zIndex: 6 }}>
        <div className="marquee-wrap" style={{ background: 'var(--ink)' }}>
          <div className="marquee">
            <span className="mi"> CHAKRAVYUHA</span><span className="md">◈</span>
            <span className="mi">VYUHANTARA</span><span className="md">◈</span>
            <span className="mi">ROOPAYANTRA</span><span className="md">◈</span>
            <span className="mi"> UDBHAVA</span><span className="md">◈</span>
            <span className="mi">SUTRADHARA</span><span className="md">◈</span>
            <span className="mi">ASTRACODERS</span><span className="md">◈</span>
            <span className="mi">BRAHMASTRA</span><span className="md">◈</span>
            <span className="mi">DRISHTICHAKRA</span><span className="md">◈</span>
            {/* DUPLICATE */}
            <span className="mi"> CHAKRAVYUHA</span><span className="md">◈</span>
            <span className="mi">VYUHANTARA</span><span className="md">◈</span>
            <span className="mi">ROOPAYANTRA</span><span className="md">◈</span>
